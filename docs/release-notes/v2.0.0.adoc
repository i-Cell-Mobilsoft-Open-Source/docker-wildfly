...
====
You can override default dialect with `PERSISTENCE_HIBERNATE_DIALECT` environment variable but you dont need to set it in the `docker-compose.yml` anymore.
