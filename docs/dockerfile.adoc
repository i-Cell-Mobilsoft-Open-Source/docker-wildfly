...
.LABEL
LABEL is a very important part of the builtelt docker images.
...
The dockerfile is responsible for EXPOSE of the basic 8080 and 9990 ports,
and the wildfly startup CMD.

=== wildfly/microprofile
Expands the base image created by common, with microprofile and executor config.
...
== wildfly/oracle-jdbc
The wildfly in the given docker base image is supplemented with the logstash + oracle driver.
...
include::../dockerfile/script/wildfly-cli/embed-server/configure-logging.adoc[]
include::../dockerfile/script/wildfly-cli/embed-server/configure-logging-file.adoc[]
include::../dockerfile/script/wildfly-cli/embed-server/configure-logstash.adoc[]
include::../dockerfile/script/wildfly-cli/embed-server/configure-managed-executor.adoc[]
include::../dockerfile/script/wildfly-cli/embed-server/configure-opentracing.adoc[]
include::../dockerfile/script/wildfly-cli/embed-server/configure-metrics.adoc[]
include::../dockerfile/script/wildfly-cli/embed-server/configure-health.adoc[]
include::../dockerfile/script/wildfly-cli/embed-server/configure-undertow.adoc[]
include::../dockerfile/script/wildfly-cli/embed-server/configure-property-replacement.adoc[]
include::../dockerfile/script/wildfly-cli/embed-server/add-oracle-datasource.adoc[]
include::table/config-keys.end.adoc[]

== wildfly/postgresql-jdbc
The wildfly in the given docker base image is supplemented with the logstash + postgresql driver.
...
include::../dockerfile/script/wildfly-cli/embed-server/configure-undertow.adoc[]
include::../dockerfile/script/wildfly-cli/embed-server/configure-property-replacement.adoc[]
include::../dockerfile/script/wildfly-cli/embed-server/add-postgresql-datasource.adoc[]
include::table/config-keys.end.adoc[]

== wildfly/ibm-mq
Add ibm-mq deployment to the wildfly in the given docker base image.
